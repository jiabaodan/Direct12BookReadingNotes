...
class BoxAnimation : public D3DApp
{
public:
	BoxAnimation(HINSTANCE hInstance);
	BoxAnimation(const BoxAnimation& rhs) = delete;
	BoxAnimation& operator=(const BoxAnimation& rhs) = delete;
	~BoxAnimation();
