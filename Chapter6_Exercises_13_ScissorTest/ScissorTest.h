...
class ScissorTest : public D3DApp
{
public:
	ScissorTest(HINSTANCE hInstance);
	ScissorTest(const ScissorTest& rhs) = delete;
	ScissorTest& operator=(const ScissorTest& rhs) = delete;
	~ScissorTest();
