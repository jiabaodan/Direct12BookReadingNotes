...
class LargeBuffer : public D3DApp
{
public:
	LargeBuffer(HINSTANCE hInstance);
	LargeBuffer(const LargeBuffer& rhs) = delete;
	LargeBuffer& operator=(const LargeBuffer& rhs) = delete;
	~LargeBuffer();
