...
class HalfViewport : public D3DApp
{
public:
	HalfViewport(HINSTANCE hInstance);
	HalfViewport(const HalfViewport& rhs) = delete;
	HalfViewport& operator=(const HalfViewport& rhs) = delete;
	~HalfViewport();
