#include "MirrorModify.h"

const int gNumFrameResources = 3;

MirrorModify::MirrorModify(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
}

MirrorModify::~MirrorModify()
{
	if (md3dDevice != nullptr)
		FlushCommandQueue();
}

bool MirrorModify::Initialize()
{
...
void MirrorModify::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void MirrorModify::Draw(const GameTimer& gt)
{
	...
	//// Exercise 5
	//// Draw wall
	//mCommandList->SetPipelineState(mPSOs["exercise2"].Get());
	//auto passCB = mCurrFrameResource->PassCB->Resource();
	//mCommandList->SetGraphicsRootConstantBufferView(2, passCB->GetGPUVirtualAddress());
	//DrawRenderItems(mCommandList.Get(), mRitemLayer[(int)RenderLayer::Opaque]);
...
void MirrorModify::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void MirrorModify::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void MirrorModify::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void MirrorModify::OnKeyboardInput(const GameTimer& gt)
{
	//
...
void MirrorModify::UpdateCamera(const GameTimer& gt)
{
...
void MirrorModify::AnimateMaterials(const GameTimer& gt)
{

}

void MirrorModify::UpdateObjectCBs(const GameTimer& gt)
{
...
void MirrorModify::UpdateMaterialCBs(const GameTimer& gt)
{
...
void MirrorModify::UpdateMainPassCB(const GameTimer& gt)
{
...
void MirrorModify::UpdateReflectedPassCB(const GameTimer& gt)
{
...
void MirrorModify::LoadTextures()
{
...
void MirrorModify::BuildRootSignature()
{
...
void MirrorModify::BuildDescriptorHeaps()
{
	//
	// Create the SRV heap.
	//
...
void MirrorModify::BuildShadersAndInputLayout()
{
...
void MirrorModify::BuildRoomGeometry()
{
...
void MirrorModify::BuildSkullGeometry()
{
...
void MirrorModify::BuildPSOs()
{
	...
	//// PSO 1
	//D3D12_DEPTH_STENCIL_DESC exerciseDSS1;
	//exerciseDSS1.DepthEnable = false;
	//exerciseDSS1.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ALL;
	//exerciseDSS1.DepthFunc = D3D12_COMPARISON_FUNC_LESS;
	//exerciseDSS1.StencilEnable = false;

	//D3D12_GRAPHICS_PIPELINE_STATE_DESC exercisePsoDesc1 = opaquePsoDesc;
	//exercisePsoDesc1.DepthStencilState = exerciseDSS1;
	//ThrowIfFailed(md3dDevice->CreateGraphicsPipelineState(&exercisePsoDesc1, IID_PPV_ARGS(&mPSOs["exercise1"])));

	//// PSO 2
	//D3D12_DEPTH_STENCIL_DESC exerciseDSS2;
	//exerciseDSS2.DepthEnable = true;
	//exerciseDSS2.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ALL;
	//exerciseDSS2.DepthFunc = D3D12_COMPARISON_FUNC_LESS;
	//exerciseDSS2.StencilEnable = false;

	//D3D12_GRAPHICS_PIPELINE_STATE_DESC exercisePsoDesc2 = opaquePsoDesc;
	//exercisePsoDesc2.DepthStencilState = exerciseDSS2;
	//ThrowIfFailed(md3dDevice->CreateGraphicsPipelineState(&exercisePsoDesc2, IID_PPV_ARGS(&mPSOs["exercise2"])));
}

void MirrorModify::BuildFrameResources()
{
...
void MirrorModify::BuildMaterials()
{
...
void MirrorModify::BuildRenderItems()
{
...
void MirrorModify::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> MirrorModify::GetStaticSamplers()
{
