...
class VertexTopology : public D3DApp
{
public:
	VertexTopology(HINSTANCE hInstance);
	VertexTopology(const VertexTopology& rhs) = delete;
	VertexTopology& operator=(const VertexTopology& rhs) = delete;
	~VertexTopology();
