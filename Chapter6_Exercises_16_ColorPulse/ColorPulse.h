...
class ColorPulse : public D3DApp
{
public:
	ColorPulse(HINSTANCE hInstance);
	ColorPulse(const ColorPulse& rhs) = delete;
	ColorPulse& operator=(const ColorPulse& rhs) = delete;
	~ColorPulse();
